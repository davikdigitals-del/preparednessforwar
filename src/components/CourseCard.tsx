...
export function CourseCard({ course, featured = false }: CourseCardProps) {
  ...
  return (
    <>
      <div className={`bg-white border-2 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-xl ${featured ? "border-blue-900" : "border-gray-200 hover:border-blue-900"
        }`}>
          ...
          <div className="flex items-center justify-between text-xs text-gray-500 mb-3">
            <div className="flex items-center gap-3">
              <span className="flex items-center gap-1">
                ...
                <span className="font-semibold text-gray-700">{(course.rating || 0).toFixed(1)}</span>
                      ...
                      {allLessons.map((lesson, idx) => {
                        ...
                        return (
                          <div
                            ...
                            className={`flex items-center gap-3 px-3 py-2.5 transition-colors ${isVideo && playable
                                ? "cursor-pointer hover:bg-blue-50 group"
                                : "cursor-default"
                              }`}
                          >
                            <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 transition-colors ${isVideo && playable
                    ...
                    {allLessons.map((lesson, idx) => {
                      ...
                      return (
                        <button
                          ...
                          className={`shrink-0 w-36 text-left px-2.5 py-2 rounded-lg border transition-all text-xs ${active

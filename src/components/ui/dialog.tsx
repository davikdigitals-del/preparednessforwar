...
// Stable portal container outside React's root — prevents removeChild crash
function getPortalContainer(): HTMLElement {
  let el = document.getElementById("dialog-portal-root");
  if (!el) {
    el = document.createElement("div");
    el.id = "dialog-portal-root";
...
const DialogPortal = ({ children, ...props }: DialogPrimitive.DialogPortalProps) => {
  ...
  React.useEffect(() => { setContainer(getPortalContainer()); }, []);

...
// Valid email regex — blocks obvious fake/random emails
...
export default function SignUpPage() {
  ...
  const isPasswordStrong = PASSWORD_RULES.every(r => r.test(password));
    ...
    if (ok) {
      ...
      if (cachedProvider && cachedProvider !== "email") {
        const providerName =
          ...
          cachedProvider === "discord" ? "Discord" : "a social login";
      ...
      <Card className="w-full max-w-md mx-4">
        ...
        <CardContent>
          ...
          {signupDone ? (
            ...
            // autocomplete="on" tells the browser this is a signup form — triggers password save prompt
            <form onSubmit={handleSubmit} className="space-y-4" autoComplete="on">
              ...
              <div>
                ...
                <Input
                  ...
                  // pattern blocks the form at browser level too
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    // "new-password" tells browser/Google to offer to save this password
              ...
              {lastSignInMethod && (
                <div className="text-center mb-3">
                  <p className="text-xs text-muted-foreground">
                    Last used: <span className="font-semibold text-primary capitalize">
                      {lastSignInMethod === 'email' ? 'Email & Password' : lastSignInMethod}
                    </span>
                  </p>
                </div>
              )}

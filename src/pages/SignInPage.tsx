    ...
    try {
      ...
      if (error) {
        if (error.status === 500 || error.message?.toLowerCase().includes("unexpected")) {
          setResetError(`Email error: ${error.message || "500 from Supabase"}`);
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              <Button
                ...
                className={`w-full flex items-center justify-center transition-all ${suggestedProvider === 'google'
              ...
              <Button
                ...
                className={`w-full flex items-center justify-center transition-all ${suggestedProvider === 'apple'
              ...
              <Button
                ...
                className={`w-full flex items-center justify-center transition-all ${suggestedProvider === 'discord'

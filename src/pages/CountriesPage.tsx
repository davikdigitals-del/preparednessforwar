...
/* ÔöÇÔöÇ Risk level assignment (static demo data) ÔöÇÔöÇ */
...
const REGIONS: { label: string; icon: string; codes: string[] }[] = [
  { label: "North America", icon: "­ƒîÄ", codes: ["US", "CA"] },
  { label: "Western Europe", icon: "­ƒîì", codes: ["GB","FR","DE","IT","ES","PT","NL","BE","LU","IS"] },
  { label: "Northern Europe", icon: "­ƒîì", codes: ["NO","SE","FI","DK"] },
  { label: "Eastern Europe", icon: "­ƒîì", codes: ["PL","CZ","SK","RO","BG","HR","SI","AL","ME","MK"] },
  { label: "Baltic States", icon: "­ƒîì", codes: ["LT","LV","EE"] },
  { label: "Southern Europe", icon: "­ƒîì", codes: ["GR","TR"] },
];
...
const CountriesPage = () => {
  ...
  // Country spotlight ÔÇö pick first high/extreme risk country

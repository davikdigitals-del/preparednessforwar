...
export default function SubscribePage() {
  ...
  return (
    <div className="min-h-screen bg-white py-10 px-4 sm:py-16">
      ...
      <div className="text-center mb-8 sm:mb-10">
        ...
        <p className="text-gray-500 text-base sm:text-lg">Simple, flexible pricing, no excuses.</p>
      </div>
      ...
      {displayPlans.length === 0 ? (
        ...
        <div className={`grid gap-4 sm:gap-6 mx-auto px-0 sm:px-4 ${
          ...
          {displayPlans.map((plan, idx) => {
            ...
            return (
              <div key={plan.id} className={`relative rounded-2xl border-2 p-5 sm:p-8 flex flex-col gap-4 sm:gap-6 transition-all hover:shadow-lg ${
                isPopular
                ...
                <div>
                  ...
                  <div className="flex items-end gap-1">
                    ...
                    <span className="text-gray-400 text-sm sm:text-base mb-1.5 sm:mb-2">
                ...
                {/* CTA */}
                <Button
                  className="w-full py-5 sm:py-6 text-sm sm:text-base font-bold rounded-xl bg-gray-900 hover:bg-gray-800 text-white"
      ...
      {/* Trust line */}
      <div className="mt-10 sm:mt-12 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-8 text-xs sm:text-sm text-gray-400">

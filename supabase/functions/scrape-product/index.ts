...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    // Store the original price and currency exactly as scraped
    // Frontend will handle conversion to GBP for display
    return new Response(
      JSON.stringify({
        name,
        description,
        image_url,
        images,
        price: priceData.price, // Original price amount as scraped
        currency: priceData.currency, // Original currency as detected
        video_url,
        affiliate_network,
      }),

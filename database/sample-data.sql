-- ============================================
-- SAMPLE DATA FOR SENTINEL NETWORK
-- ⚠️ IMPORTANT: Run schema.sql FIRST before running this file!
-- ============================================

-- This file provides test data for your Sentinel Network website
-- It matches the exact schema defined in schema.sql and types.ts

-- ============================================
-- SENTINEL NETWORK DATABASE SCHEMA
-- Complete SQL for all website features
-- ============================================
...
LEFT JOIN post_comments pc ON p.id = pc.post_id
LEFT JOIN post_reactions pr2 ON p.id = pr2.post_id
...
LEFT JOIN post_comments pc ON p.id = pc.user_id
...
-- - media (for videos, podcasts)
-- - library (for documents, PDFs)
...
-- 5. Test all features through the admin panel
